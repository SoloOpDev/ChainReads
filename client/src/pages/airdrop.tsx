...
export default function Airdrop() {
  ...
  const handleDownload = () => {
    if (selectedPost?.image) {
      ...
      link.download = `airdrop-${selectedPost.channel}-${selectedPost.messageId}.jpg`;
      ...
      <div className="min-h-screen airdrop-bg -mt-16 pt-16">
        <div className="relative z-10">
          <div className="pt-6 pb-4" style={{ paddingLeft: '15px', paddingRight: '15px' }}>
            <h1 className="text-3xl font-bold mb-6 bg-gradient-to-r from-purple-400 to-violet-400 bg-clip-text text-transparent border-b-2 border-purple-500/30 pb-4">
  ...
  return (
    <div className="min-h-screen airdrop-bg -mt-16 pt-16">
      ...
      {selectedPost && selectedPost.image && (
        <>
          ...
          <div className="fixed inset-0 z-[10000] flex items-center justify-center p-8 pointer-events-none">
            <div 
              className="relative bg-gray-800/60 backdrop-blur-md rounded-xl shadow-2xl border border-purple-500/40 overflow-hidden pointer-events-auto animate-in zoom-in-95 duration-200"
              style={{ maxWidth: '900px', maxHeight: '85vh' }}
              onClick={(e) => e.stopPropagation()}
            >
              {/* Header */}
              <div className="flex items-center justify-between p-4 border-b border-purple-500/30 bg-gray-700/25">
                <div className="flex items-center gap-3">
                  <Badge className="bg-purple-600 text-white">{selectedPost.channel}</Badge>
                ...
                <div className="flex items-center gap-2">
                  ...
                  <button
                    ...
                    className="p-2 rounded-lg bg-purple-500/20 hover:bg-purple-500/30 transition-colors disabled:opacity-30 disabled:cursor-not-allowed"
                    title="Previous (←)"
                  >
              ...
              {/* Footer Info */}
              <div className="p-4 border-t border-purple-500/30 bg-gray-700/25">
      ...
      <div className="relative z-10">
        ...
        <div className="pt-6 pb-4 px-4 md:px-8 flex flex-col md:flex-row items-start md:items-center justify-between gap-4 border-b-2 border-purple-500/30 mb-6">
